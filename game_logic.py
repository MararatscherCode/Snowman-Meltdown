...
def play_game() -> None:
    ...
    while True:
        ...
        # Check win/lose conditions after processing the guess so the final state
        # is displayed once (below) instead of being shown both before and after
        # the message.
    ...
    # Final state display (single display after loop)
